...
| 3 | [Case 3](#case-3) | 2025-06-13 | **BYOI PHP-based RAT** (Cloudflare Tunnel) | **Agent_AGen.HR / Doina / Zusy** (VT 44/74) | **High** |
...
## 📊 Case 3 — BYOI PHP-based RAT (2025-06-13)
...
### VirusTotal API Setup (for Case 3)
